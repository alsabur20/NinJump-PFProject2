...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// void generateObstacles(int &mainTick, int leftCanonBulletX[], int leftCanonBulletY[], int rightCanonBulletX[], int rightCanonBulletY[], int &leftCanonBulletCount, int &rightCanonBulletCount, int leftCanonX, int leftCanonY, int rightCanonX, int rightCanonY, char snakeRight[4][3], char snakeLeft[4][3], int rightSnakeX[], int rightSnakeY[], int &rightSnakeCount, int rSnakeX, int rSnakeY, int leftSnakeX[], int leftSnakeY[], int &leftSnakeCount, int lSnakeX, int lSnakeY, char canonLeft[3][3], char canonRight[3][3], bool &isLeftCanonPresent, bool &isRightCanonPresent, bool &isLeftSnakePresent, bool &isRightSnakePresent);
    ...
    while (1) {
        ...
        if (choice == 1) {
            ...
            while (lifeCount > 0) {
                ...
                // generateObstacles(mainTick, leftCanonBulletX, leftCanonBulletY, rightCanonBulletX, rightCanonBulletY, leftCanonBulletCount, rightCanonBulletCount, leftCanonX, leftCanonY, rightCanonX, rightCanonY, snakeRight, snakeLeft, rightSnakeX, rightSnakeY, rightSnakeCount, rSnakeX, rSnakeY, leftSnakeX, leftSnakeY, leftSnakeCount, lSnakeX, lSnakeY, canonLeft, canonRight, isLeftCanonPresent, isRightCanonPresent, isLeftSnakePresent, isRightSnakePresent);
